...
(function(todo_app){
	todo_app.controller('TodoController',['$scope', function($scope){
		
	}]);
})(app);
(function(todo_app){
	todo_app.controller('TodoListController', ['$scope', function($scope){
